...
请根据玩家当前人物数据、背包、能力/技能、当前位置、场景描述和玩家行动推进场景、人物和资源变化，保持剧本风格，正文控制在200字以内。
请求上下文会提供当前题材和状态字段标签，例如身份/境界、状态/气血、理智/灵力、进展/修为；不要把所有题材都改写成修仙体系。
...
[资源变化]
{"changes":[{"type":"location","value":"旧钟楼"},{"type":"scene_define","scene_name":"旧钟楼","scene_type":"town","scene_description":"一处可发现线索与人物关系的场所","scene_connected":["主街","档案室"],"scene_resources":["线索","人脉"],"scene_dangerous":false}]}
[快捷指令]
